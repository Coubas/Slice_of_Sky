    ...
    void Start()
    {
        ...
        if (PlayerData.PD.gaugesLvl.Length > 0)
        {
            ...
            if (PlayerData.PD.gaugesLvl[0] == 0 || PlayerData.PD.gaugesLvl[1] == 0)
            {
                ...
                if(PlayerData.PD.gaugesLvl[0] == 0)
                {
                    tutoPanelText.text = "To complete this level you need cacth a least 5 <color=#51A7F0FF>blue</color> spirits and bring them to the red spirit's gate.";
                }
                else
                {
                    tutoPanelText.text = "To complete this level you need cacth a least 5 <color=#F0DA2FFF>yellow</color> spirits and bring them to the red spirit's gate.";
                }
